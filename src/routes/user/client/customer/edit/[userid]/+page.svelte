...
<div class="content-wrapper">
    {#if form?.success}
    <ToastSuccess/>
    <small style="display: none;">{goto('/user/client/customer')}</small>
    {/if}
    <div class="row">
        <div class="col-xl">
            <div class="card mb-4">
              ...
              <div class="card-body">
                <form id="formAuthentication" class="mb-3" action="?/edit" method="POST" use:enhance>
                  ...
                  <div class="mb-3">
                    <label class="form-label" for="basic-icon-default-email">ادرس</label>
                    <div class="input-group input-group-merge">
                        <span id="basic-icon-default-fullname2" class="input-group-text"><i class="fa-solid fa-signs-post"></i></span>
                        <input required  type="text" class="form-control" id="info" name="info" value="{user.info}" aria-label="userID" aria-describedby="basic-icon-default-fullname2">
                    </div>
                  </div>
                  <div class="mb-3">
                    <label class="form-label" for="basic-icon-default-email">ادرس حمل بار</label>
                    <div class="input-group input-group-merge">
                        <span id="basic-icon-default-fullname2" class="input-group-text"><i class="fa-solid fa-signs-post"></i></span>
                        <input required  type="text" class="form-control" id="addressbar" name="addressbar" value="{user.addressbar}" aria-label="userID" aria-describedby="basic-icon-default-fullname2">
                    </div>
                  </div>
                  <div class="mb-3">
                    <label class="form-label" for="basic-icon-default-email">کد پستی</label>
                    <div class="input-group input-group-merge">
                        <span id="basic-icon-default-fullname2" class="input-group-text"><i class="fa-brands fa-usps"></i></span>
                        <input required  type="text" class="form-control" id="postcode" name="postcode" value="{user.postcode}" aria-label="userID" aria-describedby="basic-icon-default-fullname2">
                    </div>
                  </div>
