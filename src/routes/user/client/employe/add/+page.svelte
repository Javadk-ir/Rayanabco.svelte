                ...
                <form id="formAuthentication" class="mb-3" action="?/upload" method="POST" use:enhance>
                  <div class="mb-3">
                    ...
                    <div class="input-group input-group-merge">
                      ...
                      <input required  type="text" class="form-control" id="name" name="name" placeholder="محمد جواد کرمی" aria-label="name" aria-describedby="basic-icon-default-fullname2">
                    </div>
                  </div>
                  <div class="mb-3">
                    ...
                    <div class="input-group input-group-merge">
                        ...
                        <input required  type="text" class="form-control" id="email" name="email" placeholder="example@rayanab.com" aria-label="email" aria-describedby="basic-icon-default-fullname2">
                      </div>
                  </div>
                  <div class="mb-3">
                    ...
                    <div class="input-group input-group-merge">
                        ...
                        <input required  type="text" class="form-control" id="password" name="password" aria-label="password" aria-describedby="basic-icon-default-fullname2">
                    </div>
                  </div>
                  <div class="mb-3">
                    ...
                    <div class="input-group input-group-merge">
                        ...
                        <input required  type="text" class="form-control" id="userID" name="userID" placeholder="example" aria-label="userID" aria-describedby="basic-icon-default-fullname2">
                    </div>
                  </div>
                  <div class="mb-3">
                    ...
                    <div class="input-group input-group-merge">
                        ...
                        <input required  type="text" class="form-control" id="phoneNumber" name="phoneNumber" aria-label="userID" aria-describedby="basic-icon-default-fullname2">
                    </div>
                  </div>
