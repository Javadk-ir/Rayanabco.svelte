                ...
                <div class="mb-3" id="productslist">
                  ...
                  <div class="mb-3">
                    ...
                    <div class="input-group input-group-merge">
                      ...
                      <input name="caption1 " type="text" id="basic-icon-default-email" class="form-control text-start" placeholder="علت درخواست, توضیحات و ..." aria-describedby="basic-icon-default-email2" >
                    </div>
                  </div>
