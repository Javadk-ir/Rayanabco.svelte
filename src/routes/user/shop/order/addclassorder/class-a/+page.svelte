                  ...
                  <div class="row gy-4" >
                    ...
                    <div class="col-sm-6 col-lg-4 h-100">
                        <div class="card">
                            ...
                            {#if products.cAG16B !=undefined && products.cAG16B != null && products.cAG16B > 2}
                            <label for="16gb">16 GB</label>
                            <input name="{products.title}ظرفیت 16 گیگ,{products.cAG16B}" type="number" class="form-control"
                            min="0" max="{products.mG16B}"><br>
                            {/if}
                            {#if products.cAG32B != undefined && products.cAG32B != null && products.cAG32B > 2}
                            <label for="16gb">32 GB</label>
                            <input name="{products.title} ظرفیت 32 گیگ,{products.cAG32B}" type="number" class="form-control"
                            min="0" max="{products.mG32B}"><br>
                            {/if}
                            {#if products.cAG64B != undefined && products.cAG64B != null && products.cAG64B > 2}
                            <label for="16gb">64 GB</label>
                            <input name="{products.title}ظرفیت 64 گیگ,{products.cAG64B}" type="number" class="form-control"
                            min="0" max="{products.mG64B}"><br>
                            {/if}
                            {#if products.cAG64B != undefined && products.cAG64B != null && products.cAG64B > 2}
                            <label for="128 GB">128 GB</label>
                            <input name="{products.title}ظرفیت 128 گیگ,{products.cAG128B}" type="number" class="form-control"
                              style="float: right;" min="0" max="{products.mG128B}"><br>
                            {/if}
                            {#if products.cAG256B !=undefined && products.cAG256B != null && products.cAG256B> 2}
                            <label for="256 GB">256 GB</label>
                            <input name="{products.title}ظرفیت 256 گیگ,{products.cAG256B}" type="number" class="form-control"
                              style="float: right;" min="0" max="{products.mG256B}"><br>
                            {/if}
                            {#if products.cAG512B !=undefined && products.cAG512B != null && products.cAG512B> 2}
                            <label for="512 GB">512 GB</label>
                            <input name="{products.title} ظرفیت 512 گیگ,{products.cAG512B}" type="number" class="form-control"
                              style="float: right;" min="0" max="{products.mG512B}"><br>
                            {/if}
                            {#if products.cAT1B !=undefined && products.cAT1B != null && products.cAT1B> 2}
                            <label for="1 TB">1 TB</label>
                            <input name="{products.title}ظرفیت 1 ترابایت,{products.cAT1B}" type="number"
                              class="form-control" min="0" style="float: right;" max="{products.mT1B}"><br>
                            {/if}
                            {#if products.cAT2B !=undefined && products.cAT2B != null && products.cAT2B> 2 }
                            <label for="2 TB">2 TB</label>
                            <input name="{products.title}ظرفیت 2 ترابایت,{products.cAT2B}" type="number"
