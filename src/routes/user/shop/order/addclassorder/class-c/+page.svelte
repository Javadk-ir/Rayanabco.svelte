                  ...
                  <div class="row gy-4" >
                    ...
                    <div class="col-sm-6 col-lg-4 h-100">
                        <div class="card">
                            ...
                            {#if products.cCG16B !=undefined && products.cCG16B != null && products.cCG16B > 2}
                            <label for="16gb">16 GB</label>
                            <input name="{products.title}ظرفیت 16 گیگ,{products.cCG16B}" type="number" class="form-control"
                            min="0" max="{products.mG16B}"><br>
                            {/if}
                            {#if products.cCG32B != undefined && products.cCG32B != null && products.cCG32B > 2}
                            <label for="16gb">32 GB</label>
                            <input name="{products.title} ظرفیت 32 گیگ,{products.cCG32B}" type="number" class="form-control"
                            min="0" max="{products.mG32B}"><br>
                            {/if}
                            {#if products.cCG64B != undefined && products.cCG64B != null && products.cCG64B > 2}
                            <label for="16gb">64 GB</label>
                            <input name="{products.title}ظرفیت 64 گیگ,{products.cCG64B}" type="number" class="form-control"
                            min="0" max="{products.mG64B}"><br>
                            {/if}
                            {#if products.cCG64B != undefined && products.cCG64B != null && products.cCG64B > 2}
                            <label for="128 GB">128 GB</label>
                            <input name="{products.title}ظرفیت 128 گیگ,{products.cCG128B}" type="number" class="form-control"
                              style="float: right;" min="0" max="{products.mG128B}"><br>
                            {/if}
                            {#if products.cCG256B !=undefined && products.cCG256B != null && products.cCG256B> 2}
                            <label for="256 GB">256 GB</label>
                            <input name="{products.title}ظرفیت 256 گیگ,{products.cCG256B}" type="number" class="form-control"
                              style="float: right;" min="0" max="{products.mG256B}"><br>
                            {/if}
                            {#if products.cCG512B !=undefined && products.cCG512B != null && products.cCG512B> 2}
                            <label for="512 GB">512 GB</label>
                            <input name="{products.title} ظرفیت 512 گیگ,{products.cCG512B}" type="number" class="form-control"
                              style="float: right;" min="0" max="{products.mG512B}"><br>
                            {/if}
                            {#if products.cCT1B !=undefined && products.cCT1B != null && products.cCT1B> 2}
                            <label for="1 TB">1 TB</label>
                            <input name="{products.title}ظرفیت 1 ترابایت,{products.cCT1B}" type="number"
                              class="form-control" min="0" style="float: right;" max="{products.mT1B}"><br>
                            {/if}
                            {#if products.cCT2B !=undefined && products.cCT2B != null && products.cCT2B> 2 }
                            <label for="2 TB">2 TB</label>
                            <input name="{products.title}ظرفیت 2 ترابایت,{products.cCT2B}" type="number"
